				...
				<div class="row">
					<div class="col-xs-12">
						<div class="image-holder overlay">
							<img src="https://via.placeholder.com/370x555" alt="image" class="img-responsive">
						...
						<div class="image-holder overlay mar">
							<img src="https://via.placeholder.com/370x320" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
						<div class="image-holder overlay img-col">
							<img src="https://via.placeholder.com/750x320" alt="image" class="img-responsive">
							<a href="#" class="icon lg-round text-center"><i class="fa fa-search" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
