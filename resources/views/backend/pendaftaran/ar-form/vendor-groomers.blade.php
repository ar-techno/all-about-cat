<div class="modal fade" id="ar-modal-groomers" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="largeModalLabel">Identitas Groomers</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-2 col-sm-4 form-control-label">
                            <label for="nama_menu">Groomers</label>
                        </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="text" id="no_telp" class="form-control" placeholder="Nomor Telepon" value="Groomers Kucing" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-2 col-sm-4 form-control-label">
                            <label for="nama_menu">Izin Usaha</label>
                        </div>
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="text" name="email" class="form-control email" placeholder="Izin Usaha Yang Di dirikan">
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
