<div class="modal fade" id="ar-modal-V2" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form-edit-V2">
                    {{ csrf_field() }}
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <select class="form-control show-tick" id="OstatusV2" name="status" >
            ...
            <div class="modal-footer">
                <button type="button" onclick="editPendaftar('V2')" class="btn btn-default btn-round waves-effect">SAVE CHANGES</button>
