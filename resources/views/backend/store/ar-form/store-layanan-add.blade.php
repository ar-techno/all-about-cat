<div class="modal fade" id="ar-modal-layanan-add" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="height: 70%">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="ar-modal-form-layanan-add">
                     {{ csrf_field() }}
                    ...
                    <div class="row clearfix" style="display: none;">
                        <div class="col-lg-3 col-md-2 col-sm-4 form-control-label">
                            <label for="jenis_vendor_id">Id Jenis Vendor </label>
                        </div>
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="number" id="jenis_vendor_id" name="jenis_vendor_id" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <select class="form-control select2" style="width: 100%" id="layanan_id" name="layanan_id">
            ...
            <div class="modal-footer">
                <button type="button" id="save-data-layanan-add" class="btn btn-default btn-round waves-effect">SAVE CHANGES</button>
