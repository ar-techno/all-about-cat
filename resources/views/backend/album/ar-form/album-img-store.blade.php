<div class="modal " id="ar-modal-img-store" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;z-index: 999999999">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  id="ar-form-store-img" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="text" id="nama_album" name="nama_album" class="form-control" placeholder="Nama Album" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-2 col-sm-4 form-control-label">
                            <label for="vendor_id">Nama Gambar</label>
                        </div>
                        <div class="col-lg-9 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="text" id="nama_gambar" name="nama_gambar" class="form-control" placeholder="Nama Gambar">
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
            ...
            <div class="modal-footer">
                <button type="button" id="save_images" class="btn btn-default btn-round waves-effect"><i class="zmdi zmdi-upload zmdi-hc-lg"></i> Save</button>
                <button type="button" onclick="hideModal('ar-modal-img-store')" class="btn btn-danger waves-effect" data-dismiss="modal">CLOSE</button>
            </div>
        </div>
    </div>
</div>